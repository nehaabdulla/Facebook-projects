...
public class friend_accept extends AppCompatActivity {
    public static final String ACCEPT_URL ="http://services.trainees.baabtra.com/facebook1/index.php/Services_api/friendAccept";
    public static final String DECLINE_URL ="http://services.trainees.baabtra.com/facebook1/index.php/Services_api/declineFriend";
